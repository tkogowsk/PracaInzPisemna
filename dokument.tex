...
tabela z danymi (Rysunek numer \ref{fig:table1pic}).
...
Obie te wady zostały zniwelowane poprzez wprowadzenie paginacji zwanej też stronicowaniem.
...
Mnogość kolumn, porowadząca do przedstawianie wielu informacji nie potrzebnych 
...
kolejny raz ukrywać nieinteresujących go kolumn. Po rejestracji użytkownik ma wybrane wszystkie
...
Filtrowanie  
W górnej części panelu widoczne są przyciski z nazwami filtrów. Aktywny filtr
wyróżnia się od zielonym kolorem od nieaktywnych szarych filtrów. 
